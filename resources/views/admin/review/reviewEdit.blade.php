...
@section('maincontent')
    ...
    <div class="page-wrapper">
        <div class="page-content">
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Review Edit</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-body">
                    <h6 class="mb-0 text-uppercase">Review Information Edit</h6>
                    <hr/>

                    <form action="/reviewUpdate{{$review->id}}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <input class="form-control mb-3" name="quote" id="quote" type="text" value="{{$review->quote}}"
                               placeholder=" Enter quote (if any)"
                               aria-label="default input example" required>

                        <label for="image" class="control-label mb-1">Image</label>
                        <input class="form-control mb-3" name="image" id="image" type="file" value="{{$review->image}}"
                               aria-label=" default input example" required>
