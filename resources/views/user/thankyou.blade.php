...
<!-- Mirrored from digimark.themetags.com/thank-you.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 14 Mar 2021 16:32:09 GMT -->

<!-- Mirrored from mediaiconik.com/thank-you.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 22 Feb 2022 10:21:07 GMT -->
<head>
    <meta charset="utf-8">
            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-md-9 col-lg-7">
                    <div class="hero-content-left text-white text-center">
                        ...
                        <p class="lead">We will be in touch shortly. We're looking forward to your demo. If you have any
                            questions prior to your demo feel free to give us a call.</p>

                        <div class="mb-5">
                            <h5 class="mb-0 text-white"><span class="ti-mobile mr-2 align-items-center"></span> (612)
                                255-461</h5>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-5 col-lg-5">
                    <form action="#" method="post"
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <input type="submit" class="button btn secondary-solid-btn" id="submit-footer"
                                   value="Subscribe">
                        </div>
                    </form>
                </div>
...
<!-- Mirrored from mediaiconik.com/thank-you.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 22 Feb 2022 10:21:08 GMT -->
</html>
