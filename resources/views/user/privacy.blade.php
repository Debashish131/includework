                ...
                <div class="row align-items-center justify-content-center">
                    <div class="col-md-9 col-lg-7">
                        <div class="page-header-content text-white text-center pt-sm-5 pt-md-5 pt-lg-0">
                            <h3 class="text-white mb-0">Privacy</h3>
                            <div class="custom-breadcrumb">
                                <ol class="breadcrumb d-inline-block bg-transparent list-inline py-0">
                                    <li class="list-inline-item breadcrumb-item"><a href="/">Home</a></li>

                                    <li class="list-inline-item breadcrumb-item"><a href="#">Company</a></li>
                                    <li class="list-inline-item breadcrumb-item active">Privacy</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-md-10 col-lg-9">
                        <div class="section-heading text-center">
                            <strong class="color-secondary">Privacy Police</strong>
                            <h4>Last updated: April 04, 2022</h4>
                            <span class="animate-border mr-auto ml-auto mb-4"></span>
                            <p class="">This Privacy Policy describes Our policies and procedures on the collection,
                        ...
                        <div class="about-content-right mb-md-4 mb-lg-0 my-md-3 ">
                            ...
                            <ul>
                                ...
                                <li>
                                    <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;,
                                        &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to includework,
                                        California.</p>
                                </li>
                                <li>
                                ...
                                <li>
                                    <p><strong>Website</strong> refers to includework, accessible from <a
                                            href="https://www.includework.com" rel="external nofollow noopener"
                                            target="_blank">https://www.includework.com</a></p>
                                </li>
                                <li>
